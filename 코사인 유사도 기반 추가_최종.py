...
situation_list = ["시험기간", "면접", "데이트", "미팅","축제","MT","OT","개총","새터","개강","졸업","입학"]
style_list = ["casual", "sporty", "street", "vintage", "dandy", "lovely"]

# 상황, 스타일 벡터화
def vectorize_context(item, situation):
    situation_vec = [1 if situation == s else 0 for s in situation_list]
